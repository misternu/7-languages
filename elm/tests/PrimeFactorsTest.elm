...
suite =
  describe "Prime Factors"
      ...
      , test "has factors of [2, 2, 3] for 12" <|
        \_ ->
          Expect.equal [2, 2, 3] (primeFactors 12)
      , test "has factors of [2, 2, 2, 2, 3] for 48" <|
        \_ ->
          Expect.equal [2, 2, 2, 2, 3] (primeFactors 48)
      ]
