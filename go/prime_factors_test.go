...
var _ = Describe("Factors", func() {
  ...
  It("has factors of 12 as [2, 2, 3]", func() {
    Expect(prime_factors.Factors(12)).To(Equal([]int{2, 2, 3}))
  })
  It("has factors of 48 as [2, 2, 2, 2, 3]", func() {
    Expect(prime_factors.Factors(48)).To(Equal([]int{2, 2, 2, 2, 3}))
  })
})
