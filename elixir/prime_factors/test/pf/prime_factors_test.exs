defmodule PF.PrimeFactorsTest do
  ...
  test "factors of 12 are [2, 2, 3]" do
    assert PF.PrimeFactors.prime_factors(12) == [2, 2, 3]
  end
  test "factors of 48 are [2, 2, 2, 2, 3]" do
    assert PF.PrimeFactors.prime_factors(48) == [2, 2, 2, 2, 3]
  end
end
